...
export const ko = {
  ...
  sigil: {
    ...
    legend:
      '칸 하나가 커밋 하나입니다. 깊이는 그 커밋이 직접 바꾼 줄 수이고, 바깥으로 튀어나온 표시는 저장소가 스스로 선언한 페이즈입니다. 비어 있는 {remaining}칸은 아직 쓰이지 않았습니다. 다 차면 안쪽에 새 링이 생기고 바깥 링은 그대로 굳습니다 — 이미 그려진 것은 다시 움직이지 않습니다.',
