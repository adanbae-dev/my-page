...
> = {
  light: [
    ...
    { role: 'decline', ratio: 3.13, min: 3, usage: 'Diverging scale, the falling half — non-text' },
  ...
  dark: [
    ...
    { role: 'decline', ratio: 5.76, min: 3, usage: 'Diverging scale, the falling half — non-text' },
